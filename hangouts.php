...
<!-- NAVBAR
  ...
  <body style="background-image:url(static/images/1.jpg)" >
    ...
    $result = mysqli_query($con, "SELECT h.h_name as Name, h.h_type as Category, h.h_money as 'Minimum Cost', e.h_add as Address FROM hangouts h, h_add e where h.h_id = e.h_id");
    ...
    <div class="container">
      <font color="black">
        <h1 align='center'>Details of Hangouts </h1>
